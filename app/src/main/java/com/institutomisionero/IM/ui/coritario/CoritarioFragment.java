...
public class CoritarioFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        Lista.add(new Datos(72, "Jesús es mi vida"));
        Lista.add(new Datos(73, "Jesús mi guía es"));
        Lista.add(new Datos(74, "Jesús te ama"));
        Lista.add(new Datos(75, "Jesús, tú eres mi alegría"));
        Lista.add(new Datos(76, "La alegría"));
        Lista.add(new Datos(77, "La mañana gloriosa"));
        Lista.add(new Datos(78, "La sangre de Cristo Jesús"));
        Lista.add(new Datos(79, "Lado a lado"));
        Lista.add(new Datos(80, "Llévame a la cruz"));
        Lista.add(new Datos(81, "Majestuoso Dios"));
        Lista.add(new Datos(82, "Maranata"));
        Lista.add(new Datos(83, "Maravillas"));
        Lista.add(new Datos(84, "Maravilloso Dios"));
        Lista.add(new Datos(85, "Me siento bien"));
        Lista.add(new Datos(86, "Mensajero"));
        Lista.add(new Datos(87, "Mi Cristo me salva"));
        Lista.add(new Datos(88, "Mi Dios puede salvar"));
        Lista.add(new Datos(89, "Mi Dios, supremo Rey"));
        Lista.add(new Datos(90, "Mi reino"));
        Lista.add(new Datos(91, "Mira qué linda es la vida"));
        Lista.add(new Datos(92, "Mirad cuál amor"));
        Lista.add(new Datos(93, "Necesario"));
        Lista.add(new Datos(94, "No existe bien para mí"));
        Lista.add(new Datos(95, "No importa de dónde tú vengas"));
        Lista.add(new Datos(96, "No me olvidé de ti"));
        Lista.add(new Datos(97, "Nunca estés desanimado"));
        Lista.add(new Datos(98, "Oba oba"));
        Lista.add(new Datos(99, "Océanos"));
        Lista.add(new Datos(100, "Oh, amor de Dios"));
        Lista.add(new Datos(101, "Padre de amor"));
        Lista.add(new Datos(102, "Padre, yo te adoro"));
        Lista.add(new Datos(103, "Paso a paso"));
        Lista.add(new Datos(104, "Paz en la tormenta"));
        Lista.add(new Datos(105, "Pescador"));
        Lista.add(new Datos(106, "Poema de salvación"));
        Lista.add(new Datos(107, "Pon tus manos en las manos del Señor"));
        Lista.add(new Datos(108, "Por encima de todo"));
        Lista.add(new Datos(109, "Por eso alabamos"));
        Lista.add(new Datos(110, "Por eso le amo"));
        Lista.add(new Datos(111, "Por tu gracia y amor"));
        Lista.add(new Datos(112, "Príncipe de paz"));
        Lista.add(new Datos(113, "Promesa"));
        Lista.add(new Datos(114, "Queremos ver"));
        Lista.add(new Datos(115, "Queremos ver a Cristo regresar"));
        Lista.add(new Datos(116, "Quién dices que soy"));
        Lista.add(new Datos(117, "Quiero cantar una linda canción"));
        Lista.add(new Datos(118, "Rendid a Yahvé"));
        Lista.add(new Datos(119, "Renuévame"));
        Lista.add(new Datos(120, "Restaura"));
        Lista.add(new Datos(121, "Salmo 1"));
        Lista.add(new Datos(122, "Santo es el Señor"));
        Lista.add(new Datos(123, "Santo Espíritu"));
        Lista.add(new Datos(124, "Sé una luz"));
        Lista.add(new Datos(125, "Sentado estaba en mi barca"));
        Lista.add(new Datos(126, "Señor, aviva tu obra en mí"));
        Lista.add(new Datos(127, "Señor, tu gracia"));
        Lista.add(new Datos(128, "Sólo en ti"));
        Lista.add(new Datos(129, "Somos la luz"));
        Lista.add(new Datos(130, "Somos su voz"));
        Lista.add(new Datos(131, "Tal como soy"));
        Lista.add(new Datos(132, "Te exaltaré"));
        Lista.add(new Datos(133, "Tengo paz como un río"));
        Lista.add(new Datos(134, "Tomados de la mano"));
        Lista.add(new Datos(135, "Todopoderoso"));
        Lista.add(new Datos(136, "Tu amor me inundó"));
        Lista.add(new Datos(137, "Tu amor por mí"));
        Lista.add(new Datos(138, "Tu poder"));
        Lista.add(new Datos(139, "Tu santo nombre"));
        Lista.add(new Datos(140, "Tuyo soy"));
        Lista.add(new Datos(141, "Un millón"));
        Lista.add(new Datos(142, "Vamos a adorar"));
        Lista.add(new Datos(143, "Vaso de honra"));
        Lista.add(new Datos(144, "Ven a la cruz"));
        Lista.add(new Datos(145, "Ven, es tiempo de adorarle"));
        Lista.add(new Datos(146, "Vengo a adorarte"));
        Lista.add(new Datos(147, "Veré a Jesús"));
        Lista.add(new Datos(148, "Voy caminando"));
        Lista.add(new Datos(149, "Yo soy feliz"));
        Lista.add(new Datos(150, "Yo tengo esperanza"));                //doble 148
        Lista.add(new Datos(151, "Yo voy"));                            //159 a ... (i+6)
